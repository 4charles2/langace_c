...
silent only
cd ~/Bureau/langage_C/langace_c/jeu_sokoban
...
exe '4resize ' . ((&lines * 27 + 32) / 65)
exe 'vert 4resize ' . ((&columns * 76 + 115) / 230)
exe '5resize ' . ((&lines * 9 + 32) / 65)
exe 'vert 5resize ' . ((&columns * 76 + 115) / 230)
exe '6resize ' . ((&lines * 9 + 32) / 65)
exe 'vert 6resize ' . ((&columns * 76 + 115) / 230)
exe '7resize ' . ((&lines * 15 + 32) / 65)
exe 'vert 7resize ' . ((&columns * 76 + 115) / 230)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
